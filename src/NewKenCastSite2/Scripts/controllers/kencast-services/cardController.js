(function () {
    ...
    angular
        .module('kencast')
        .controller('cardController', ['$state',function ($state) {
            ...
            //this.selectCard = function (card) {
            //    for (var i = 0; i < this.cardImages.length; i++) {
            //        if (this.cardImages[i].image === this.image) {
            //            this.image = this.cardImages[i].image;
            //            this.title = this.cardImages[i].title;
